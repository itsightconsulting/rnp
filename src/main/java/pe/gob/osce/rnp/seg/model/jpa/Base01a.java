...
@Entity
@Data
public class Base01a {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "ID_ESTADO_RNC")
	private Integer idEstdoRnc;
	...
	private String restri02;

	@Column(name = "RESTRI03")
	private String restri03;
	...
	@Column(name = "NU_MODIF")
	private int nuModif;

	@Column(name = "ID_FISCALIZACION")
	private int idFiscalizacion;

	@Column(name = "F_DESAPROB")
	@Temporal(TemporalType.TIMESTAMP)
	private Date fDesaprob;

	@Column(name = "ID_ESTADO_FISCA")
	private String idEstadoFisca;

	@Column(name = "FH_INICIO_FISCA")
	private String fhInicioFisca;

	@Column(name = "FH_FIN_FISCA")
	private String fhFinFisca;

	@Column(name = "ID_ESTADO_SELEC")
	private String idEstadoSelec;
	...
	@Temporal(TemporalType.DATE)
	private Date feEscritura;

	@Column(name = "TMONEDA_MSUSCRITO")
	private String tMonedaMsuscrito;
